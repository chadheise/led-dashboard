...
class TimezonesLibrary(Library):
    ...
    icon: ClassVar[str] = (
        ...
        '<path d="M12 22q-2.075 0-3.9-.788t-3.175-2.137q-1.35-1.35-2.137-3.175T2 12q0-2.075'
        '.788-3.9t2.137-3.175Q6.275 3.575 8.1 2.787T12 2q2.075 0 3.9.788t3.175 2.137q1.35 '
        '1.35 2.138 3.175T22 12q0 2.075-.788 3.9t-2.137 3.175q-1.35 1.35-3.175 '
        '2.137T12 22Zm3.05-5.05L16.4 15.6 12.75 12V7h-1.5v5.6l3.8 3.8Z"/></svg>'
    )
