      ...
      <div style={pageStyle}>
        ...
        {!isEditing && (
          <>
            ...
            {/* Featured active playlist — always at top */}
            {activePlaylist && (
              <div style={{ marginBottom: 28 }}>
                ...
                >
                  ...
                  {activePlaylist.items.length > 0 ? (
                    <ol
                      style={{ margin: "4px 0 0 0", padding: 0, display: "flex", flexDirection: "column", gap: 6, fontFamily: F.family }}
                    >
                      {activePlaylist.items.map((it, i) => (
                        <div key={i} style={{ display: "flex", alignItems: "center", gap: 8 }}>
                          ...
                          <span style={{ color: C.textSecondary, fontSize: F.size.base }}>
                            {it.module_name}
                          </span>
            ...
            {/* Full playlist list — original order, never reordered */}
              ...
              <div key={pl.id} style={cardStyle(pl.is_active)}>
                <div style={rowStyle}>
                  ...
                  <div style={{ display: "flex", gap: 6 }}>
                    ...
                    <button onClick={() => openEdit(pl)} style={btn()}>
                      EDIT
                    </button>
                    <button onClick={() => remove(pl.id)} style={btn("danger")}>
                      ✕
                    </button>
                  </div>
                </div>
                {pl.items.length > 0 ? (
                  <ol
                    style={{ margin: "8px 0 0 0", padding: 0, display: "flex", flexDirection: "column", gap: 5, fontFamily: F.family }}
                  >
                    {pl.items.map((it, i) => (
                      <div key={i} style={{ display: "flex", alignItems: "center", gap: 8 }}>
                        <div style={{ color: C.textMuted, flexShrink: 0 }}>
                        ...
                        <span style={{ color: C.textSecondary, fontSize: F.size.sm }}>
                          {it.module_name}
                        </span>
                        <span style={{ color: C.textMuted, fontSize: F.size.xs }}>
                          · {it.duration}s
                        </span>
                      </div>
                    ))}
            ...
            <div>
              ...
              {fItems.map((item, idx) => (
                ...
                >
                  ...
                  <button onClick={() => removeItem(idx)} style={btn("danger")}>
                    ✕
                  </button>
                </div>
              ))}
